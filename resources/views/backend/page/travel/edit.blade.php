            ...
            <div class="card mb-4 border-left-primary">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <select name="traner_id" class="form-control text-dark border-1 small col-md-9">
                            ...
                            @foreach($trainer as $train)
                                <option value="{{$train->id}}" {!! ($row->traner_id == $train->id?"selected":"") !!}>{{$train->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <input type="number" value="{{$row->price}}" name="price" class="form-control text-dark border-1 small col-md-3" required>
                        <label class="col-md-2 offset-md-1 mt-2">Available Seat</label>
                        <input type="number" value="{{$row->seat_available}}" name="seat_available" class="form-control text-dark border-1 small col-md-3" required>
                    </div>
                    <div class="form-group row mb-3">
